...
.. list-table:: Services
   ...
   * - HyperLedger
     ...
     - | `GitHub actions <https://github.com/hyperledger>`_
       | `Circle CI <https://app.circleci.com/pipelines/github/hyperledger-labs>`_
       | `Azure <https://dev.azure.com/Hyperledger>`_
     - N/A
   ...
   * - ODPi
     ...
     - | `Azure Pipelines <https://dev.azure.com/ODPi/Egeria/_build>`_
       | `GitHub actions <https://github.com/odpi>`_
     - N/A
     - N/A
   ...
   * - Zowe
     ...
     - `GitHub Actions <https://github.com/zowe>`_
     - N/A
     - N/A
     - https://zowe.jfrog.io/
     - N/A
