...
2. If you are using a GPG smartcard refer to `Offline Master keys and Subkeys Guide <https://blog.josefsson.org/2014/06/23/offline-gnupg-master-key-and-subkeys-on-yubikey-neo-smartcard/>`_
...
3. A green check next to the users name on the Gerrit change should suggest a
