...
- Does the commit message have an 'Issue: <someissue>' (or any similar tag such
  as 'Issue-Id:' or 'JIRA:'   in the footer and not in the subject line or body?
- Are there any typos?
...
- If important changes are brought by the commit(s), is an appropriate
