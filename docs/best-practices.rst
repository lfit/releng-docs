...
recommende regardless of activity as a committer on any project in particular.
...
interactive mode. In this case, insall Coala in a Python VirtualEnv. We
recommend using a script called VirtualEnvWrapper as it makes it simple
to manage local virtual environments.
