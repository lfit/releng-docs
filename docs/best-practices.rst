...
#. Fork your `$PROJECT/$REPO` to your personal Github account
   ...
   * NOTE if you are forking the ci-management repository you should consider changing the local fork name after you have forked it to be `$PROJECT-ci-management` this will do two things for you:
   * Let you know which upstream project the ci-management repo it's for
   * Allow you to easily fork the *next* ci-management repository that you might need to work on
#. Clone **your** repo
...
#. Create local branch and do your work (just like with gerrit)
...
#. Raise PR against the upstream (note: when pushing a branch from your local to your fork the CLI gives you a URL for quickly raising the PR)

Care and feeding of your fork
-----------------------------

Your fork will fall out of sync with the upstream repo so be sure to tend to your fork before working on it.
