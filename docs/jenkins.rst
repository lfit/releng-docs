...
instance, but in this case a new `LF Helpdesk <mailto:helpdesk@rt.linuxfoundation.org>`_ ticket (for the related
...
default way to use the Sandbox since does not require for the user to install JJB or
configure it at all.
