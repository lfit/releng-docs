...
You can install JJB and its dependencies with `pip <Installing JJB using pip_>`_
...
is available in `pip-assisted <Installing JJB using pip_>`_ install.

Virtual Environments
--------------------

For `pip-assisted <Installing JJB using pip_>`_, we recommend using
