...
scheduled intervals. The cron job deletes all logs older than 6 months on the
production environment everyday at 08:00 UTC and deletes all logs older than a
week on the sandbox environment every Saturday at 08:00 UTC.
