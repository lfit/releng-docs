...
can be tied down to a specific JJB version, because JJB is fairly
unstable, it may be necessary to debug issues by installing different versions.
...
.. code-block:: bash
    ...
    $ virtualenv jjb
    # A new virtual env dir was created
...
With your virtual environment active, you should install JJB which only be
...
To validate that JJB is installed successfully run this command:
