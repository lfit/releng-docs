...
Test global-jjb or lftools changes on the master with the Jenkins Jobs
======================================================================

To test one or more changes in review state on the global-jjb or lftools
repository with a Jenkins jobs on sandbox, insert the sample code in the
in the relevant builder section on the job. This reduces the number of
regressions and/or hot fixes required post-release.
