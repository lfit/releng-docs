...
#. Click on the anonymous http tab.
...
#. Copy the clone command. For example:

   .. code-block:: bash

      git clone https://USERNAME@gerrit.linuxfoundation.org/infra/a/releng/docs

#. Paste the command in your terminal and follow the user/password prompts.
...
#. Get the command from Projects->List->Select any project->General->Clone
