...
.. note::
   ...
   Here's more information on `Gerrit <google-gerrit>`_
...
.. note::
    ...
    Here's more information on `SSH keys for Ubuntu <ssh-keys>`_
    and more on `generating SSH keys <generating-ssh>`_
