...
latex_documents = [
    (master_doc, 'LinuxFoundationReleaseEngineeringDocs.tex', 'Linux Foundation Release Engineering Documentation',
     'Linux Foundation Releng', 'manual'),
]
...
man_pages = [
    (master_doc, 'linuxfoundationreleaseengineeringdocs', 'Linux Foundation Release Engineering Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LinuxFoundationReleaseEngineeringDocs', 'Linux Foundation Release Engineering Documentation',
     author, 'LinuxFoundationReleaseEngineeringDocs', 'One line description of project.',
     'Miscellaneous'),
]
